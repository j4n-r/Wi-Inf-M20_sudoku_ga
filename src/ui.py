...
def render_sudoku(sudoku: SudokuCandidate):
    ...
    top_border  = f"{C_GRID}{TOP_L}{spacer}{TOP_M}{spacer}{TOP_M}{spacer}{TOP_R}{C_RESET}"
    mid_divider = f"{C_GRID}{MID_L}{spacer}{MID_M}{spacer}{MID_M}{spacer}{MID_R}{C_RESET}"
    bot_border  = f"{C_GRID}{BOT_L}{spacer}{BOT_M}{spacer}{BOT_M}{spacer}{BOT_R}{C_RESET}"
